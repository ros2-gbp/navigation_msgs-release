## navigation_msgs (lyrical) - 2.6.1-1

The packages in the `navigation_msgs` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --track lyrical --rosdistro lyrical navigation_msgs` on `Thu, 30 Apr 2026 17:04:22 -0000`
...
## navigation_msgs (rolling) - 2.6.1-1

The packages in the `navigation_msgs` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling navigation_msgs` on `Thu, 30 Apr 2026 17:02:31 -0000`
